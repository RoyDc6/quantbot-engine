...
def fetch_and_analyze(symbol, market='HK'):
    ...
    return {
        ...
        'llm_alpha_mode': fusion.get('llm_alpha_mode', 'weighted'),
        'llm_audit_score': fusion.get('llm_audit_score', llm_s.get('sentiment_score', 0.0)),
        'reserved_weights': fusion.get('reserved_weights', {}),
        'weights_used': fusion.get('weights_used', {}),
        'normalization_denominator': fusion.get('normalization_denominator', 1.0),
